...
- This file applies to every project; keep project-specific guidance in the project's own `AGENTS.md`.
...
- For GitHub operations or GitHub documentation, read `~/.config/ai/docs/github.md`.
