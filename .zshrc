...
plugins=(git vi-mode z ssh-agent)

source $ZSH/oh-my-zsh.sh

# ssh-add identities
zstyle :omz:plugins:ssh-agent identities cipherlogs
...
nodevim() {
  local sanctuary="const S = require('sanctuary').unchecked;"
  local def="const $ = require('sanctuary-def');"
...
# claude code
export OPENROUTER_API_KEY="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"
